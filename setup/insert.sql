...
INSERT INTO `config` (`id`, `name`, `secured`, `hidden`, `created_at`, `updated_at`) VALUES
(1, 'check-available-stock', 0, 0, NOW(), NOW()),
(2, 'active-front-template', 0, 0, NOW(), NOW()),
(3, 'active-admin-template', 0, 0, NOW(), NOW()),
(4, 'active-pdf-template', 0, 0, NOW(), NOW()),
(5, 'active-mail-template', 0, 0, NOW(), NOW()),
(6, 'rewriting_enable', 0, 0, NOW(), NOW()),
(7, 'imagine_graphic_driver', 0, 0, NOW(), NOW()),
(8, 'default_images_quality_percent', 0, 0, NOW(), NOW()),
(9, 'original_image_delivery_mode', 0, 0, NOW(), NOW()),
(10, 'original_document_delivery_mode', 0, 0, NOW(), NOW()),
(11, 'images_library_path', 0, 0, NOW(), NOW()),
(12, 'documents_library_path', 0, 0, NOW(), NOW()),
(13, 'image_cache_dir_from_web_root', 0, 0, NOW(), NOW()),
(14, 'document_cache_dir_from_web_root', 0, 0, NOW(), NOW()),
(15, 'page_not_found_view', 0, 0, NOW(), NOW()),
(16, 'obsolete_rewriten_url_view', 0, 0, NOW(), NOW()),
(17, 'use_tax_free_amounts', 0, 0, NOW(), NOW()),
(18, 'process_assets', 0, 0, NOW(), NOW()),
(19, 'thelia_admin_remember_me_cookie_name', 0, 0, NOW(), NOW()),
(20, 'thelia_admin_remember_me_cookie_expiration', 0, 0, NOW(), NOW()),
(21, 'thelia_customer_remember_me_cookie_name', 0, 0, NOW(), NOW()),
(22, 'thelia_customer_remember_me_cookie_expiration', 0, 0, NOW(), NOW()),
(23, 'url_site', 0, 0, NOW(), NOW()),
(24, 'pdf_invoice_file', 0, 0, NOW(), NOW()),
(25, 'pdf_delivery_file', 0, 0, NOW(), NOW()),
(26, 'unknown-flag-path', 0, 0, NOW(), NOW()),
(27, 'html_output_trim_level', 0, 0, NOW(), NOW()),
(28, 'default_available_stock', 0, 0, NOW(), NOW()),
(29, 'information_folder_id', 0, 0, NOW(), NOW()),
(30, 'terms_conditions_content_id', 0, 0, NOW(), NOW()),
(31, 'allow_negative_stock', 0, 0, NOW(), NOW()),
(32, 'cart.use_persistent_cookie', 0, 0, NOW(), NOW()),
(33, 'cart.cookie_name', 0, 0, NOW(), NOW()),
(34, 'cart.cookie_lifetime', 0, 0, NOW(), NOW()),
(35, 'session_config.lifetime', 0, 0, NOW(), NOW()),
(36, 'session_config.default', 1, 1, NOW(), NOW()),
(37, 'default_lang_without_translation', 1, 1, NOW(), NOW()),
...
(42, 'one_domain_foreach_lang', 1, 1, NOW(), NOW()),
(43, 'thelia_version', 1, 1, NOW(), NOW()),
(44, 'thelia_major_version', 1, 1, NOW(), NOW()),
(45, 'thelia_minus_version', 1, 1, NOW(), NOW()),
(46, 'thelia_release_version', 1, 1, NOW(), NOW()),
(47, 'thelia_extra_version', 1, 1, NOW(), NOW()),
(48, 'front_cart_country_cookie_name', 1, 1, NOW(), NOW()),
(49, 'front_cart_country_cookie_expires', 1, 1, NOW(), NOW()),
(50, 'sitemap_ttl', 1, 1, NOW(), NOW()),
(51, 'feed_ttl', 1, 1, NOW(), NOW()),
(52, 'form_firewall_bruteforce_time_to_wait', 0, 0, NOW(), NOW()),
(53, 'form_firewall_time_to_wait', 0, 0, NOW(), NOW()),
(54, 'form_firewall_bruteforce_attempts', 0, 0, NOW(), NOW()),
(55, 'form_firewall_attempts', 0, 0, NOW(), NOW()),
(56, 'form_firewall_active', 0, 0, NOW(), NOW()),
(57, 'allow_slash_ended_uri', 0, 0, NOW(), NOW()),
(58, 'error_message.show', 0, 0, NOW(), NOW()),
(59, 'error_message.page_name', 0, 0, NOW(), NOW()),
(60, 'customer_change_email', 0, 0, NOW(), NOW()),
(61, 'customer_confirm_email', 0, 0, NOW(), NOW()),
(62, 'form.secret', 0, 0, NOW(), NOW()),
(63, 'minimum_admin_password_length', 0, 0, NOW(), NOW()),
(64, 'enable_lost_admin_password_recovery', 0, 0, NOW(), NOW()),
(65, 'notify_newsletter_subscription', 0, 0, NOW(), NOW()),
(66, 'number_default_results_per_page.product_list', 0, 0, NOW(), NOW()),
(67, 'number_default_results_per_page.order_list', 0, 0, NOW(), NOW()),
(68, 'number_default_results_per_page.customer_list', 0, 0, NOW(), NOW()),
(69, 'customer_email_confirmation', 0, 0, NOW(), NOW()),
(70, 'number_default_results_per_page.coupon_list', 0, 0, NOW(), NOW()),
(71, 'cdn.documents-base-url', 0, 0, NOW(), NOW()),
(72, 'cdn.assets-base-url', 0, 0, NOW(), NOW()),
(73, 'allow_module_zip_install', 0, 0, NOW(), NOW())
...
INSERT INTO `config_i18n` (`id`, `locale`, `value`, `title`, `description`, `chapo`, `postscriptum`) VALUES
(1, 'cs_CZ', '1', NULL, NULL, NULL, NULL),
(2, 'cs_CZ', 'default', NULL, NULL, NULL, NULL),
(3, 'cs_CZ', 'default', NULL, NULL, NULL, NULL),
(4, 'cs_CZ', 'default', NULL, NULL, NULL, NULL),
(5, 'cs_CZ', 'default', NULL, NULL, NULL, NULL),
(6, 'cs_CZ', '1', NULL, NULL, NULL, NULL),
(7, 'cs_CZ', 'gd', NULL, NULL, NULL, NULL),
(8, 'cs_CZ', '90', NULL, NULL, NULL, NULL),
(9, 'cs_CZ', 'symlink', NULL, NULL, NULL, NULL),
(10, 'cs_CZ', 'symlink', NULL, NULL, NULL, NULL),
(11, 'cs_CZ', 'local/media/images', NULL, NULL, NULL, NULL),
(12, 'cs_CZ', 'local/media/documents', NULL, NULL, NULL, NULL),
(13, 'cs_CZ', 'cache/images', NULL, NULL, NULL, NULL),
(14, 'cs_CZ', 'cache/documents', NULL, NULL, NULL, NULL),
(15, 'cs_CZ', '404.html', NULL, NULL, NULL, NULL),
(16, 'cs_CZ', 'obsolete-rewritten-url', NULL, NULL, NULL, NULL),
(17, 'cs_CZ', '0', NULL, NULL, NULL, NULL),
(18, 'cs_CZ', '0', NULL, NULL, NULL, NULL),
(19, 'cs_CZ', 'tarmcn', NULL, NULL, NULL, NULL),
(20, 'cs_CZ', '2592000', NULL, NULL, NULL, NULL),
(21, 'cs_CZ', 'tcrmcn', NULL, NULL, NULL, NULL),
(22, 'cs_CZ', '31536000', NULL, NULL, NULL, NULL),
(23, 'cs_CZ', '', NULL, NULL, NULL, NULL),
(24, 'cs_CZ', 'invoice', NULL, NULL, NULL, NULL),
(25, 'cs_CZ', 'delivery', NULL, NULL, NULL, NULL),
(26, 'cs_CZ', 'assets/img/flags/unknown.png', NULL, NULL, NULL, NULL),
(27, 'cs_CZ', '1', NULL, NULL, NULL, NULL),
(28, 'cs_CZ', '100', NULL, NULL, NULL, NULL),
(29, 'cs_CZ', '', NULL, NULL, NULL, NULL),
(30, 'cs_CZ', '', NULL, NULL, NULL, NULL),
(31, 'cs_CZ', '0', NULL, NULL, NULL, NULL),
(32, 'cs_CZ', '1', NULL, NULL, NULL, NULL),
(33, 'cs_CZ', 'thelia_cart', NULL, NULL, NULL, NULL),
(34, 'cs_CZ', '31536060', NULL, NULL, NULL, NULL),
(35, 'cs_CZ', '0', NULL, NULL, NULL, NULL),
(36, 'cs_CZ', '1', NULL, NULL, NULL, NULL),
(37, 'cs_CZ', '1', NULL, NULL, NULL, NULL),
(52, 'cs_CZ', '10', NULL, NULL, NULL, NULL),
(53, 'cs_CZ', '60', NULL, NULL, NULL, NULL),
(54, 'cs_CZ', '10', NULL, NULL, NULL, NULL),
(55, 'cs_CZ', '6', NULL, NULL, NULL, NULL),
(56, 'cs_CZ', '1', NULL, NULL, NULL, NULL),
(57, 'cs_CZ', '1', NULL, NULL, NULL, NULL),
(58, 'cs_CZ', '1', NULL, NULL, NULL, NULL),
(59, 'cs_CZ', 'error.html', NULL, NULL, NULL, NULL),
(60, 'cs_CZ', '0', NULL, NULL, NULL, NULL),
(61, 'cs_CZ', '1', NULL, NULL, NULL, NULL),
(62, 'cs_CZ', 'ThisIsNotASecret', NULL, NULL, NULL, NULL),
(63, 'cs_CZ', '4', NULL, NULL, NULL, NULL),
(64, 'cs_CZ', '1', NULL, NULL, NULL, NULL),
(65, 'cs_CZ', '1', NULL, NULL, NULL, NULL),
(66, 'cs_CZ', '20', NULL, NULL, NULL, NULL),
(67, 'cs_CZ', '20', NULL, NULL, NULL, NULL),
(68, 'cs_CZ', '20', NULL, NULL, NULL, NULL),
(69, 'cs_CZ', '0', NULL, NULL, NULL, NULL),
(70, 'cs_CZ', '20', NULL, NULL, NULL, NULL),
(71, 'cs_CZ', '', NULL, NULL, NULL, NULL),
(72, 'cs_CZ', '', NULL, NULL, NULL, NULL),
(73, 'cs_CZ', '1', NULL, NULL, NULL, NULL),
(1, 'de_DE', '1', 'Verfügbaren Lagerbestand prüfen (1) oder ignorieren (0) beim Anzeigen und Änderung der bestellte Menge', NULL, NULL, NULL),
(2, 'de_DE', 'default', 'Name der aktiven Front Office Template', NULL, NULL, NULL),
(3, 'de_DE', 'default', 'Name der aktiven Back Office Template', NULL, NULL, NULL),
(4, 'de_DE', 'default', 'Name der aktiven PDF Template', NULL, NULL, NULL),
(5, 'de_DE', 'default', 'Name der aktiven E-Mail Template', NULL, NULL, NULL),
(6, 'de_DE', '1', 'Aktivieren (1) oder deaktivieren (0) URL Überschreibung', NULL, NULL, NULL),
(7, 'de_DE', 'gd', 'Name des Grafik-Treibers, der von der Imagine-Bibliothek verwendet wird (siehe https://imagine.readthedocs.org)', NULL, NULL, NULL),
(8, 'de_DE', '90', 'Die Standardqualität (in%) der erzeugten Bilder', NULL, NULL, NULL),
(9, 'de_DE', 'symlink', 'Wie werden die Originalbilder (volle Auflösung) im Webspace ausgeliefert (symlink or copy)', NULL, NULL, NULL),
(10, 'de_DE', 'symlink', 'Wie werden Dokumentdateien im Webspace (Symlink oder Kopie) ausgeliefert', NULL, NULL, NULL),
(11, 'de_DE', 'local/media/images', 'Pfad zu dem Verzeichnis, in dem Bilder gespeichert sind', NULL, NULL, NULL),
(12, 'de_DE', 'local/media/documents', 'Pfad zu dem Verzeichnis, in dem Dokumente gespeichert sind', NULL, NULL, NULL),
(13, 'de_DE', 'cache/images', 'Der Pfad zum Bild-Cache-Verzeichnis in dem Web-Space', NULL, NULL, NULL),
(14, 'de_DE', 'cache/documents', 'Der Pfad zum Dokument-Cache-Verzeichnis in dem Web-Space', NULL, NULL, NULL),
(15, 'de_DE', '404.html', 'Name der Seite 404 (unauffindbar) in dem aktuellen Modell (mit der Dateinamenerweiterung 404.html zum Beispiel)', NULL, NULL, NULL),
(16, 'de_DE', 'obsolete-rewritten-url', 'Name des Templates zurückgegeben, wenn eine veraltete (oder inaktive) Produkt-URL aufgerufen wird', NULL, NULL, NULL),
(17, 'de_DE', '0', 'Anzeigt und verwendet Preise mit (0) oder ohne (1) Taxen', NULL, NULL, NULL),
(18, 'de_DE', '0', 'Template Assets automatisch bei Codeänderungen kompilieren? (1 = ja, 0 = nein)', NULL, NULL, NULL),
(19, 'de_DE', 'tarmcn', 'Name des Cookies \"Remember me\" für die Administratoren', NULL, NULL, NULL),
(20, 'de_DE', '2592000', 'Ablaufzeit in Sekunden des Cookies \"Remember me\" für die Administratoren', NULL, NULL, NULL),
(21, 'de_DE', 'tcrmcn', 'Name des Cookies \"Remember me\" für die Kunden', NULL, NULL, NULL),
(22, 'de_DE', '31536000', 'Ablaufzeit in Sekunden des Cookies \"Remember me\" für die Kunden', NULL, NULL, NULL),
(23, 'de_DE', '', 'Shops Basis-URL (zum Beispiel http://www.yourshopdomain.com)', NULL, NULL, NULL),
(24, 'de_DE', 'invoice', 'Name der Rechnungsansicht in der aktuellen PDF-Vorlage (ohne Erweiterung)', NULL, NULL, NULL),
(25, 'de_DE', 'delivery', 'Name der Lieferung Sicht in der aktuellen PDF-Vorlage (ohne Erweiterung)', NULL, NULL, NULL),
(26, 'de_DE', 'assets/img/flags/unknown.png', 'Der Pfad (relativ zu der Standard-Backoffice-Vorlage) zu dem verwendetes Bild wenn kein Flagge-Bild für ein Land gefunden werden kann', NULL, NULL, NULL),
(27, 'de_DE', '1', 'Whitespace trim Ebene des generierten HTML-Codes (0 = aus, 1 = Mittel, 2 = Maximum)', NULL, NULL, NULL),
(28, 'de_DE', '100', 'Standart verfügbaren Bestand wenn check-available-stock gleich 0.', NULL, NULL, NULL),
...
(31, 'de_DE', '0', 'Negativen Lagerbestand erlauben (1) oder nicht (0)', NULL, NULL, NULL),
(32, 'de_DE', '1', 'Ein dauerhaftes Cookie verwenden, um den Kundes-Warenkorb zu merken', NULL, NULL, NULL),
(33, 'de_DE', 'thelia_cart', 'Name der Warenkorb-Cookie', NULL, NULL, NULL),
(34, 'de_DE', '31536060', 'Dauer der Warenkorb-Cookie in dem Kunden-Browser, in Sekunden', NULL, NULL, NULL),
(35, 'de_DE', '0', 'Dauer der Session-Cookie in dem Kunden-Browser, in Sekunden', NULL, NULL, NULL),
(36, 'de_DE', '1', 'Die Session Standartkonfiguration lassen', NULL, NULL, NULL),
(37, 'de_DE', '1', 'Standartsprache ohne Übersetzung', NULL, NULL, NULL),
(52, 'de_DE', '10', '[Firewall/Bruteforce] Wartezeit zwischen X Versuche', NULL, NULL, NULL),
(53, 'de_DE', '60', '[Firewall] Wartezeit zwischen X Versuche', NULL, NULL, NULL),
(54, 'de_DE', '10', '[Firewall/Bruteforce] Anzahl der erlaubten Versuche', NULL, NULL, NULL),
(55, 'de_DE', '6', '[Firewall] Anzahl der erlaubten Versuche', NULL, NULL, NULL),
(56, 'de_DE', '1', '[Firewall] Firewall aktivieren', NULL, NULL, NULL),
(57, 'de_DE', '1', 'URI mit Slash beendet erlauben', NULL, NULL, NULL),
(58, 'de_DE', '1', 'Fehlermeldung zeigen anstatt einer weißen Seite im Falle eines eines Serverfehlers', NULL, NULL, NULL),
(59, 'de_DE', 'error.html', 'Dateiname der Fehlerseite', NULL, NULL, NULL),
(60, 'de_DE', '0', 'Den Kunden erlauben ihre E-Mail-Adresse zu ändern. 1 für Ja, 0 für Nein', NULL, NULL, NULL),
(61, 'de_DE', '1', NULL, NULL, NULL, NULL),
(62, 'de_DE', 'ThisIsNotASecret', 'Geheimer Schlüssel für Formular CSRF-token', NULL, NULL, NULL),
(63, 'de_DE', '4', NULL, NULL, NULL, NULL),
(64, 'de_DE', '1', NULL, NULL, NULL, NULL),
(65, 'de_DE', '1', NULL, NULL, NULL, NULL),
(66, 'de_DE', '20', NULL, NULL, NULL, NULL),
(67, 'de_DE', '20', NULL, NULL, NULL, NULL),
(68, 'de_DE', '20', NULL, NULL, NULL, NULL),
(69, 'de_DE', '0', NULL, NULL, NULL, NULL),
(70, 'de_DE', '20', NULL, NULL, NULL, NULL),
(71, 'de_DE', '', NULL, NULL, NULL, NULL),
(72, 'de_DE', '', NULL, NULL, NULL, NULL),
(73, 'de_DE', '1', 'Modulinstallation aus ZIP-Dateien zulassen.', NULL, NULL, NULL),
(1, 'en_US', '1', 'Check available product stock (1) or ignore it (0) when displaying and changing ordered quantity', NULL, NULL, NULL),
(2, 'en_US', 'default', 'Name of the active front-office template', NULL, NULL, NULL),
(3, 'en_US', 'default', 'Name of the active back-office template', NULL, NULL, NULL),
(4, 'en_US', 'default', 'Name of the active PDF template', NULL, NULL, NULL),
(5, 'en_US', 'default', 'Name of the active mailing template', NULL, NULL, NULL),
(6, 'en_US', '1', 'Enable (1) or disable (0) URL rewriting', NULL, NULL, NULL),
(7, 'en_US', 'gd', 'Name of the graphic driver used by the Imagine library (see https://imagine.readthedocs.org)', NULL, NULL, NULL),
(8, 'en_US', '90', 'The default quality (in %) of the generated images', NULL, NULL, NULL),
(9, 'en_US', 'symlink', 'How original (full resolution) images are delivered in the web space (symlink or copy)', NULL, NULL, NULL),
(10, 'en_US', 'symlink', 'How document files are delivered in the web space (symlink or copy)', NULL, NULL, NULL),
(11, 'en_US', 'local/media/images', 'Path to the directory where images are stored', NULL, NULL, NULL),
(12, 'en_US', 'local/media/documents', 'Path to the directory where documents are stored', NULL, NULL, NULL),
(13, 'en_US', 'cache/images', 'The path to the image cache directory in the web space', NULL, NULL, NULL),
(14, 'en_US', 'cache/documents', 'The path to the document cache directory in the web space', NULL, NULL, NULL),
(15, 'en_US', '404.html', 'File name of the 404 (not found) view in the current template (with extension, e.g. 404.html)', NULL, NULL, NULL),
(16, 'en_US', 'obsolete-rewritten-url', 'Name of the template view returned when an obsolete (or inactive) product URL is invoked', NULL, NULL, NULL),
(17, 'en_US', '0', 'Display and process prices with (0) or without (1) taxes.', NULL, NULL, NULL),
(18, 'en_US', '0', 'Compile templates assets automatically upon asset source change (1 = yes, 0 = no)', NULL, NULL, NULL),
(19, 'en_US', 'tarmcn', '\"Remember me\" cookie name for administration users', NULL, NULL, NULL),
(20, 'en_US', '2592000', '\"Remember me\" cookie expiration time, in seconds, for administration users', NULL, NULL, NULL),
(21, 'en_US', 'tcrmcn', '\"Remember me\" cookie name for customer users', NULL, NULL, NULL),
(22, 'en_US', '31536000', '\"Remember me\" cookie expiration time, in seconds, for customer users', NULL, NULL, NULL),
(23, 'en_US', '', 'Base URL of the shop (e.g. http://www.yourshopdomain.com)', NULL, NULL, NULL),
(24, 'en_US', 'invoice', 'Name of the invoice view in the current PDF template (without extension)', NULL, NULL, NULL),
(25, 'en_US', 'delivery', 'Name of the delivery view in the current PDF template (without extension)', NULL, NULL, NULL),
(26, 'en_US', 'assets/img/flags/unknown.png', 'The path (relative to the default back-office template) to the image used when no flag image can be found for a country', NULL, NULL, NULL),
(27, 'en_US', '1', 'Whitespace trim level of the generated HTML code (0 = none, 1 = medium, 2 = maximum)', NULL, NULL, NULL),
(28, 'en_US', '100', 'Default available stock when check-available-stock is set to 0.', NULL, NULL, NULL),
...
(31, 'en_US', '0', 'Allow negative product stock (1) or not (0)', NULL, NULL, NULL),
(32, 'en_US', '1', 'Use a persistent cookie to keep track of customer cart', NULL, NULL, NULL),
(33, 'en_US', 'thelia_cart', 'Name of the cart cookie', NULL, NULL, NULL),
(34, 'en_US', '31536060', 'Life time of the cart cookie in the customer browser, in seconds', NULL, NULL, NULL),
(35, 'en_US', '0', 'Life time of the session cookie in the customer browser, in seconds', NULL, NULL, NULL),
(36, 'en_US', '1', 'Leave the default configuration of session', NULL, NULL, NULL),
(37, 'en_US', '1', 'Default lang without translation', NULL, NULL, NULL),
(52, 'en_US', '10', '[Firewall/Bruteforce] Time to wait between X attempts', NULL, NULL, NULL),
(53, 'en_US', '60', '[Firewall] Time to wait between X attempts', NULL, NULL, NULL),
(54, 'en_US', '10', '[Firewall/Bruteforce] Number of allowed attemps', NULL, NULL, NULL),
(55, 'en_US', '6', '[Firewall] Number of allowed attemps', NULL, NULL, NULL),
(56, 'en_US', '1', '[Firewall] Activate the firewall', NULL, NULL, NULL),
(57, 'en_US', '1', 'Allow slash ended uri', NULL, NULL, NULL),
(58, 'en_US', '1', 'Show error message instead of a white page on a server error', NULL, NULL, NULL),
(59, 'en_US', 'error.html', 'Filename of the error page', NULL, NULL, NULL),
(60, 'en_US', '0', 'Allow customers to change their email. 1 for yes, 0 for no', NULL, NULL, NULL),
(61, 'en_US', '1', 'Ask the customers to confirm their email in customer creation form (1: yes, 0: no)', NULL, NULL, NULL),
(62, 'en_US', 'ThisIsNotASecret', 'Secret key for form CSRF token', NULL, NULL, NULL),
(63, 'en_US', '4', 'The minimum length required for an administrator password', NULL, NULL, NULL),
(64, 'en_US', '1', 'Allow an administrator to recreate a lost password (1 = yes, 0 = no)', NULL, NULL, NULL),
(65, 'en_US', '1', 'Send a confirmation email to newsletter subscribers (1 = yes, 0 = no)', NULL, NULL, NULL),
(66, 'en_US', '20', 'Default number of products on product list', NULL, NULL, NULL),
(67, 'en_US', '20', 'Default number of orders on order list', NULL, NULL, NULL),
(68, 'en_US', '20', 'Default number of customers on customer list', NULL, NULL, NULL),
(69, 'en_US', '0', 'Customer account creation should be confirmed by email (1: yes, 0: no)', NULL, NULL, NULL),
(70, 'en_US', '20', 'Default number of coupons per page on coupon list', NULL, NULL, NULL),
(71, 'en_US', '', NULL, NULL, NULL, NULL),
(72, 'en_US', '', NULL, NULL, NULL, NULL),
(73, 'en_US', '1', 'Allow module installation from ZIP files.', NULL, NULL, NULL),
(1, 'es_ES', '1', 'Comprobar disponibilidad de stock de producto (1) o ignorar (0) cuando se muestra o cambia cantidad en pedido', NULL, NULL, NULL),
(2, 'es_ES', 'default', 'Nombre de la plantilla activa de recepción', NULL, NULL, NULL),
(3, 'es_ES', 'default', 'Nombe de la plantilla del administrador activo', NULL, NULL, NULL),
(4, 'es_ES', 'default', 'Nombre de la plantilla PDF activa', NULL, NULL, NULL),
(5, 'es_ES', 'default', 'Nombre de la plantilla de correo activa', NULL, NULL, NULL),
(6, 'es_ES', '1', 'Activar(1) o desactivar(0) reescritura de URL', NULL, NULL, NULL),
(7, 'es_ES', 'gd', 'Nombre del controlador gráfico usado por la Librería Imagine (ver https://imagine.readthedocs.org)', NULL, NULL, NULL),
(8, 'es_ES', '90', 'La calidad por defecto (en %) de las imágenes generadas', NULL, NULL, NULL),
(9, 'es_ES', 'symlink', 'Cómo se entregan imágenes originales (resolución completa) en el espacio de la web (enlace o copia)', NULL, NULL, NULL),
(10, 'es_ES', 'symlink', 'Cómo los documento son enviados en el espacio de la web (enlace o copia)', NULL, NULL, NULL),
(11, 'es_ES', 'local/media/images', 'Ruta al directorio donde las imágenes estén guardadas', NULL, NULL, NULL),
(12, 'es_ES', 'local/media/documents', 'Ruta al directorio donde los documentos estén guardados', NULL, NULL, NULL),
(13, 'es_ES', 'cache/images', 'La ruta de acceso para el directorio de caché de imagen en el espacio web', NULL, NULL, NULL),
(14, 'es_ES', 'cache/documents', 'La ruta al directorio de caché de documentos en el espacio web', NULL, NULL, NULL),
(15, 'es_ES', '404.html', 'Nombre de archivo de la vista 404 (no encontrado) en la plantilla actual (con la extensión, ej: 404.html)', NULL, NULL, NULL),
(16, 'es_ES', 'obsolete-rewritten-url', 'Nombre de la plantilla regresada cuando se llama una URL obsoleta (o inactiva) de un producto', NULL, NULL, NULL),
(17, 'es_ES', '0', 'Mostrar y procesar precios con (0) o sin (1) impuestos.', NULL, NULL, NULL),
(18, 'es_ES', '0', 'Compilar las plantillas automáticamente en cada cambio de código fuente (1 = sí, 2 = no)', NULL, NULL, NULL),
(19, 'es_ES', 'tarmcn', 'Nombre de la cookie \"Recordarme\" para los usuarios de administración', NULL, NULL, NULL),
(20, 'es_ES', '2592000', 'Fecha de caducidad de cookie \"recuerdame\", en segundos, para los usuarios de la administración', NULL, NULL, NULL),
(21, 'es_ES', 'tcrmcn', 'Nombre de la cookie \"Recordarme\" para los usuarios cliente', NULL, NULL, NULL),
(22, 'es_ES', '31536000', 'Fecha de caducidad de cookie \"Acuérdate de mi\", en segundos, para los usuarios cliente', NULL, NULL, NULL),
(23, 'es_ES', '', 'Base URL de la tienda (por ejemplo http://www.yourshopdomain.com)', NULL, NULL, NULL),
(24, 'es_ES', 'invoice', 'Nombre de la vista para la factura en la plantilla PDF actual (sin extensión)', NULL, NULL, NULL),
(25, 'es_ES', 'delivery', 'Nombre de la vista de entrega en la plantilla PDF actual (sin extensión)', NULL, NULL, NULL),
(26, 'es_ES', 'assets/img/flags/unknown.png', 'La ruta (relativa a la plantilla de back office por defecto) a la imagen que se utiliza cuando no se puede encontrar ninguna imagen de la bandera para un país', NULL, NULL, NULL),
(27, 'es_ES', '1', 'Espacio en blanco del ajuste nivel del código HTML generado (0 = ninguna, 1 = medio, 2 = máximo)', NULL, NULL, NULL),
(28, 'es_ES', '100', 'Cuando check-available-stock es 0 stock disponible por defecto.', NULL, NULL, NULL),
...
(31, 'es_ES', '0', 'Permitir valores negativos producto (1) o no (0)', NULL, NULL, NULL),
(32, 'es_ES', '1', 'Usa una \'cookie\' persistente para mantener el trayecto del carrito del cliente', NULL, NULL, NULL),
(33, 'es_ES', 'thelia_cart', 'Nombre de la cookie del carrito', NULL, NULL, NULL),
(34, 'es_ES', '31536060', 'Tiempo de vida de la cookie del carro en el navegador del cliente, en segundos', NULL, NULL, NULL),
(35, 'es_ES', '0', 'Tiempo de vida de la cookie de la sesión en el navegador del cliente, en segundos', NULL, NULL, NULL),
(36, 'es_ES', '1', 'Abandonde la configuración predeterminada de la sesión', NULL, NULL, NULL),
(37, 'es_ES', '1', 'Lenguaje por defecto sin traducción', NULL, NULL, NULL),
(52, 'es_ES', '10', '[Firewall/Bruteforce] Tiempo de espera entre X intentos', NULL, NULL, NULL),
(53, 'es_ES', '60', '[Firewall] Tiempo de espera entre X intentos', NULL, NULL, NULL),
(54, 'es_ES', '10', '[Firewall/Bruteforce] Número de intentos permitidos', NULL, NULL, NULL),
(55, 'es_ES', '6', '[Firewall] Número de intentos permitidos', NULL, NULL, NULL),
(56, 'es_ES', '1', '[Firewall] Activar el firewall', NULL, NULL, NULL),
(57, 'es_ES', '1', 'Permitir barra de fín de url', NULL, NULL, NULL),
(58, 'es_ES', '1', 'Mostrar mensaje de error en lugar de una página en blanco cuando ocurre un error de servidor', NULL, NULL, NULL),
(59, 'es_ES', 'error.html', 'Nombre de archivo de la página de error', NULL, NULL, NULL),
(60, 'es_ES', '0', 'Permitir a los clientes cambiar su correo electrónico. 1 para sí, 0 para no', NULL, NULL, NULL),
(61, 'es_ES', '1', NULL, NULL, NULL, NULL),
(62, 'es_ES', 'ThisIsNotASecret', 'Clave secreta para el token CSRF del formulario', NULL, NULL, NULL),
(63, 'es_ES', '4', 'La longitud mínima de la contraseña de administrador', NULL, NULL, NULL),
(64, 'es_ES', '1', 'Permite a un administrador recrear una contraseña perdida (1 = sí, 0 = no)', NULL, NULL, NULL),
(65, 'es_ES', '1', 'Enviar un correo de confirmación a los suscriptores del boletín (1 = sí, 0 = no)', NULL, NULL, NULL),
(66, 'es_ES', '20', 'Número predeterminado de resultados por página para la lista de productos', NULL, NULL, NULL),
(67, 'es_ES', '20', 'Número predeterminado de resultados por página para la lista de pedidos', NULL, NULL, NULL),
(68, 'es_ES', '20', 'Número predeterminado de resultados por página para la lista de clientes', NULL, NULL, NULL),
(69, 'es_ES', '0', NULL, NULL, NULL, NULL),
(70, 'es_ES', '20', NULL, NULL, NULL, NULL),
(71, 'es_ES', '', NULL, NULL, NULL, NULL),
(72, 'es_ES', '', NULL, NULL, NULL, NULL),
(73, 'es_ES', '1', 'Permitir la instalación del módulo desde archivos ZIP.', NULL, NULL, NULL),
(1, 'fr_FR', '1', 'Vérifier la présence de produits en stock (1) ou l\'ignorer (0) lors de l\'affichage et la modification des quantités commandées', NULL, NULL, NULL),
(2, 'fr_FR', 'default', 'Nom du modèle de front-office actif', NULL, NULL, NULL),
(3, 'fr_FR', 'default', 'Nom du modèle de back-office actif', NULL, NULL, NULL),
(4, 'fr_FR', 'default', 'Nom du modèle PDF actif', NULL, NULL, NULL),
(5, 'fr_FR', 'default', 'Nom du modèle d\'e-mail actif', NULL, NULL, NULL),
(6, 'fr_FR', '1', 'Activer (1) ou désactiver (0) la réécriture d\'URL', NULL, NULL, NULL),
(7, 'fr_FR', 'gd', 'Nom du pilote graphique utilisé par la bibliothèque Imagine (voir https://imagine.readthedocs.org)', NULL, NULL, NULL),
(8, 'fr_FR', '90', 'La qualité par défaut (en %) dans les images générées', NULL, NULL, NULL),
(9, 'fr_FR', 'symlink', 'Comment les images originales (pleine résolution) sont-elles fournises dans l\'espace web (lien symbolique ou copie)', NULL, NULL, NULL),
(10, 'fr_FR', 'symlink', 'Comment les documents sont-ils fournis dans l\'espace web (lien symbolique ou copie)', NULL, NULL, NULL),
(11, 'fr_FR', 'local/media/images', 'Chemin vers le répertoire où les images sont stockées', NULL, NULL, NULL),
(12, 'fr_FR', 'local/media/documents', 'Chemin vers le répertoire où sont stockés les documents', NULL, NULL, NULL),
(13, 'fr_FR', 'cache/images', 'Chemin vers le répertoire de cache d\'images dans l\'espace web', NULL, NULL, NULL),
(14, 'fr_FR', 'cache/documents', 'Chemin d\'accès au répertoire de cache de documents dans l\'espace web', NULL, NULL, NULL),
(15, 'fr_FR', '404.html', 'Nom de la page 404 (introuvable) dans le modèle actuel (avec l\'extension, par exemple, 404.html)', NULL, NULL, NULL),
(16, 'fr_FR', 'obsolete-rewritten-url', 'Nom de la page du modèle retournée lorsqu\'une URL obsolète (ou inactive) est invoquée', NULL, NULL, NULL),
(17, 'fr_FR', '0', 'Affiche et traite les prix avec(0) ou sans (1) les taxes', NULL, NULL, NULL),
(18, 'fr_FR', '0', 'Compiler les resources du modèle actif à chaque changement (1 = oui, 2 = non)', NULL, NULL, NULL),
(19, 'fr_FR', 'tarmcn', 'Nom du cookie \"Remember me\" pour les utilisateurs d\'administration', NULL, NULL, NULL),
(20, 'fr_FR', '2592000', 'Délai d\'expiration du cookie \"Remember me\", en secondes, pour les utilisateurs d\'administration', NULL, NULL, NULL),
(21, 'fr_FR', 'tcrmcn', 'Nom du cookie \"Remember me\" pour les clients', NULL, NULL, NULL),
(22, 'fr_FR', '31536000', 'Délai d\'expiration du cookie \"Remember me\", en secondes, pour les clients', NULL, NULL, NULL),
(23, 'fr_FR', '', 'URL de base pour la boutique (par exemple http://www.yourshopdomain.com)', NULL, NULL, NULL),
(24, 'fr_FR', 'invoice', 'Nom de la vue de la facture dans le modèle PDF en cours (sans extension)', NULL, NULL, NULL),
(25, 'fr_FR', 'delivery', 'Nom de la vue de la livraison dans le modèle PDF en cours (sans extension)', NULL, NULL, NULL),
(26, 'fr_FR', 'assets/img/flags/unknown.png', 'Le chemin (par rapport au modèle de back-office par défaut) vers l\'image utilisée lorsque aucune image de drapeau ne peut être trouvée pour un pays', NULL, NULL, NULL),
(27, 'fr_FR', '1', 'Niveau de découpe des espaces dans le code HTML généré (0 = aucun, 1 = moyen, 2 = maximum)', NULL, NULL, NULL),
(28, 'fr_FR', '100', 'Stock disponible par défaut quand check-available-stock est à 0.', NULL, NULL, NULL),
...
(31, 'fr_FR', '0', 'Autoriser un stock négatif sur les produits (1) ou pas (0, défaut)', NULL, NULL, NULL),
(32, 'fr_FR', '1', 'Utiliser un cookie persistant pour mémoriser le panier du client', NULL, NULL, NULL),
(33, 'fr_FR', 'thelia_cart', 'Nom du cookie de stockage du panier', NULL, NULL, NULL),
(34, 'fr_FR', '31536060', 'Durée de vie du cookie du panier dans le navigateur du client, en secondes', NULL, NULL, NULL),
(35, 'fr_FR', '0', 'Durée de vie du cookie de la session dans le navigateur du client, en secondes', NULL, NULL, NULL),
(36, 'fr_FR', '1', 'Laisser la configuration par défaut de la session', NULL, NULL, NULL),
(37, 'fr_FR', '1', 'Langue par défaut sans traduction', NULL, NULL, NULL),
(52, 'fr_FR', '10', '[Pare-feu/Bruteforce] Temps à attendre entre X essais', NULL, NULL, NULL),
(53, 'fr_FR', '60', '[Pare-feu] Temps à attendre entre X essais', NULL, NULL, NULL),
(54, 'fr_FR', '10', '[Pare-feu/Bruteforce] Nombre de tentatives autorisées', NULL, NULL, NULL),
(55, 'fr_FR', '6', '[Pare-feu] Nombre de tentatives autorisées', NULL, NULL, NULL),
(56, 'fr_FR', '1', '[Pare-feu] Activer le pare-feu', NULL, NULL, NULL),
(57, 'fr_FR', '1', 'Autoriser les URI terminées par un slash', NULL, NULL, NULL),
(58, 'fr_FR', '1', 'Afficher un message d\'erreur à la place d\'une page blanche lors d\'une erreur serveur', NULL, NULL, NULL),
(59, 'fr_FR', 'error.html', 'Nom du fichier de la page d\'erreur', NULL, NULL, NULL),
(60, 'fr_FR', '0', 'Permettre aux utilisateurs de changer leur email. 1 pour oui, 0 pour non', NULL, NULL, NULL),
(61, 'fr_FR', '1', 'Demander aux clients de confirmer leur adresse email dans le formulaire de création de compte (1: oui, 0: non)', NULL, NULL, NULL),
(62, 'fr_FR', 'ThisIsNotASecret', 'Clé secrète pour le jeton CSRF des formulaires', NULL, NULL, NULL),
(63, 'fr_FR', '4', 'La longueur minimale requise pour un mot de passe administrateur', NULL, NULL, NULL),
(64, 'fr_FR', '1', 'Permettre à un administrateur de recréer un mot de passe perdu (1 = Oui, 0 = non)', NULL, NULL, NULL),
(65, 'fr_FR', '1', 'Envoyer un email de confirmation aux abonnés de la newsletter (1 = Oui, 0 = non)', NULL, NULL, NULL),
(66, 'fr_FR', '20', 'Nombre par défaut de résultats par page pour la liste des produits', NULL, NULL, NULL),
(67, 'fr_FR', '20', 'Nombre par défaut de résultats par page pour la liste des commandes', NULL, NULL, NULL),
(68, 'fr_FR', '20', 'Nombre par défaut de résultats par page pour la liste des clients', NULL, NULL, NULL),
(69, 'fr_FR', '0', 'La création d\'un compte client doit être confirmée par email (1: oui, 0: non)', NULL, NULL, NULL),
(70, 'fr_FR', '20', 'Nombre de coupons par page dans la liste des coupons', NULL, NULL, NULL),
(71, 'fr_FR', '', NULL, NULL, NULL, NULL),
(72, 'fr_FR', '', NULL, NULL, NULL, NULL),
(73, 'fr_FR', '1', 'Autoriser l\'installation des modules par fichier ZIP.', NULL, NULL, NULL),
(1, 'it_IT', '1', NULL, NULL, NULL, NULL),
(2, 'it_IT', 'default', NULL, NULL, NULL, NULL),
(3, 'it_IT', 'default', NULL, NULL, NULL, NULL),
(4, 'it_IT', 'default', NULL, NULL, NULL, NULL),
(5, 'it_IT', 'default', NULL, NULL, NULL, NULL),
(6, 'it_IT', '1', NULL, NULL, NULL, NULL),
(7, 'it_IT', 'gd', NULL, NULL, NULL, NULL),
(8, 'it_IT', '90', NULL, NULL, NULL, NULL),
(9, 'it_IT', 'symlink', NULL, NULL, NULL, NULL),
(10, 'it_IT', 'symlink', NULL, NULL, NULL, NULL),
(11, 'it_IT', 'local/media/images', NULL, NULL, NULL, NULL),
(12, 'it_IT', 'local/media/documents', NULL, NULL, NULL, NULL),
(13, 'it_IT', 'cache/images', NULL, NULL, NULL, NULL),
(14, 'it_IT', 'cache/documents', NULL, NULL, NULL, NULL),
(15, 'it_IT', '404.html', NULL, NULL, NULL, NULL),
(16, 'it_IT', 'obsolete-rewritten-url', NULL, NULL, NULL, NULL),
(17, 'it_IT', '0', NULL, NULL, NULL, NULL),
(18, 'it_IT', '0', NULL, NULL, NULL, NULL),
(19, 'it_IT', 'tarmcn', NULL, NULL, NULL, NULL),
(20, 'it_IT', '2592000', NULL, NULL, NULL, NULL),
(21, 'it_IT', 'tcrmcn', NULL, NULL, NULL, NULL),
(22, 'it_IT', '31536000', NULL, NULL, NULL, NULL),
(23, 'it_IT', '', NULL, NULL, NULL, NULL),
(24, 'it_IT', 'invoice', NULL, NULL, NULL, NULL),
(25, 'it_IT', 'delivery', NULL, NULL, NULL, NULL),
(26, 'it_IT', 'assets/img/flags/unknown.png', NULL, NULL, NULL, NULL),
(27, 'it_IT', '1', NULL, NULL, NULL, NULL),
(28, 'it_IT', '100', NULL, NULL, NULL, NULL),
(29, 'it_IT', '', NULL, NULL, NULL, NULL),
(30, 'it_IT', '', NULL, NULL, NULL, NULL),
(31, 'it_IT', '0', NULL, NULL, NULL, NULL),
(32, 'it_IT', '1', NULL, NULL, NULL, NULL),
(33, 'it_IT', 'thelia_cart', NULL, NULL, NULL, NULL),
(34, 'it_IT', '31536060', NULL, NULL, NULL, NULL),
(35, 'it_IT', '0', NULL, NULL, NULL, NULL),
(36, 'it_IT', '1', NULL, NULL, NULL, NULL),
(37, 'it_IT', '1', NULL, NULL, NULL, NULL),
(52, 'it_IT', '10', NULL, NULL, NULL, NULL),
(53, 'it_IT', '60', NULL, NULL, NULL, NULL),
(54, 'it_IT', '10', NULL, NULL, NULL, NULL),
(55, 'it_IT', '6', NULL, NULL, NULL, NULL),
(56, 'it_IT', '1', NULL, NULL, NULL, NULL),
(57, 'it_IT', '1', NULL, NULL, NULL, NULL),
(58, 'it_IT', '1', NULL, NULL, NULL, NULL),
(59, 'it_IT', 'error.html', NULL, NULL, NULL, NULL),
(60, 'it_IT', '0', NULL, NULL, NULL, NULL),
(61, 'it_IT', '1', NULL, NULL, NULL, NULL),
(62, 'it_IT', 'ThisIsNotASecret', NULL, NULL, NULL, NULL),
(63, 'it_IT', '4', NULL, NULL, NULL, NULL),
(64, 'it_IT', '1', NULL, NULL, NULL, NULL),
(65, 'it_IT', '1', NULL, NULL, NULL, NULL),
(66, 'it_IT', '20', NULL, NULL, NULL, NULL),
(67, 'it_IT', '20', NULL, NULL, NULL, NULL),
(68, 'it_IT', '20', NULL, NULL, NULL, NULL),
(69, 'it_IT', '0', NULL, NULL, NULL, NULL),
(70, 'it_IT', '20', NULL, NULL, NULL, NULL),
(71, 'it_IT', '', NULL, NULL, NULL, NULL),
(72, 'it_IT', '', NULL, NULL, NULL, NULL),
(73, 'it_IT', '1', NULL, NULL, NULL, NULL),
(1, 'ru_RU', '1', 'Проверять доступный запас товара (1) или игнорировать его (0) при отображении и изменении количества в заказе', NULL, NULL, NULL),
(2, 'ru_RU', 'default', 'Имя активного шаблона магазина', NULL, NULL, NULL),
(3, 'ru_RU', 'default', 'Имя активного шаблона админки', NULL, NULL, NULL),
(4, 'ru_RU', 'default', 'Имя активного шаблона для PDF', NULL, NULL, NULL),
(5, 'ru_RU', 'default', 'Имя активного шаблона рассылок', NULL, NULL, NULL),
(6, 'ru_RU', '1', 'Вкл (1) или Выкл (0) URL rewriting', NULL, NULL, NULL),
(7, 'ru_RU', 'gd', 'Имя графического драйвера используемого библиотекой Imagine (см. https://imagine.readthedocs.org)', NULL, NULL, NULL),
(8, 'ru_RU', '90', 'Качество (в %) генерируемых изображений', NULL, NULL, NULL),
(9, 'ru_RU', 'symlink', 'Способ доставки оригинальных изображений в web директорию (symlink или copy)', NULL, NULL, NULL),
(10, 'ru_RU', 'symlink', 'Способ доставки документов в web директорию (symlink или copy)', NULL, NULL, NULL),
(11, 'ru_RU', 'local/media/images', 'Путь до директории где хранятся изображения', NULL, NULL, NULL),
(12, 'ru_RU', 'local/media/documents', 'Путь до дериктории где хранятся документы', NULL, NULL, NULL),
(13, 'ru_RU', 'cache/images', 'Путь до кеша изобрежений относительно web директории', NULL, NULL, NULL),
(14, 'ru_RU', 'cache/documents', 'Путь до кеша документов относительно web директории', NULL, NULL, NULL),
(15, 'ru_RU', '404.html', 'Имя файла страницы 404 (не найден) в текущем шаблоне (с расширением, например 404.html)', NULL, NULL, NULL),
(16, 'ru_RU', 'obsolete-rewritten-url', 'Имя страницы шаблона возвращаемой при вызове заброшеного (или не активного) URL товара', NULL, NULL, NULL),
(17, 'ru_RU', '0', 'Отображать и обрабатывать цены с (0) или без (1) налогов.', NULL, NULL, NULL),
(18, 'ru_RU', '0', 'Компилировать assets автоматически при изменении источника asset (1 - Да, 0 - Нет)', NULL, NULL, NULL),
(19, 'ru_RU', 'tarmcn', 'Имя cookie \"Запомнить меня\" для админов', NULL, NULL, NULL),
(20, 'ru_RU', '2592000', 'Время жизни cookie \"Запомнить меня\" в секундах, для админов', NULL, NULL, NULL),
(21, 'ru_RU', 'tcrmcn', 'Имя cookie \"Запомнить меня\" для клинтов', NULL, NULL, NULL),
(22, 'ru_RU', '31536000', 'Время жизни cookie \"Запомнить меня\" в секундах, для клиентов', NULL, NULL, NULL),
(23, 'ru_RU', '', 'Базовый URL магазина (например http://www.yourshopdomain.com)', NULL, NULL, NULL),
(24, 'ru_RU', 'invoice', 'Имя страницы текущего PDF шаблона для счет-фактуры (без расширения)', NULL, NULL, NULL),
(25, 'ru_RU', 'delivery', 'Имя страницы текущего PDF шаблона для доставки (без расширения)', NULL, NULL, NULL),
(26, 'ru_RU', 'assets/img/flags/unknown.png', 'Путь (относительно стандартного шаблона админки) к изображению для флага страны, если изображение флага не найдено', NULL, NULL, NULL),
(27, 'ru_RU', '1', 'Обрезание пробелов в генерируемом HTML (0 - нет, 1 - среднее, 2 - максимальное). Сильно влияет на производительность !', NULL, NULL, NULL),
(28, 'ru_RU', '100', 'Доступный остаток когда check-available-stock выставлен в 0', NULL, NULL, NULL),
...
(31, 'ru_RU', '0', 'Разрешить отрицательные остатки товара (1) или нет (0)', NULL, NULL, NULL),
(32, 'ru_RU', '1', 'Использовать cookie для отслеживания корзины клиента', NULL, NULL, NULL),
(33, 'ru_RU', 'thelia_cart', 'Имя cookie корзины', NULL, NULL, NULL),
(34, 'ru_RU', '31536060', 'Время жизни cookie корзины в секундах', NULL, NULL, NULL),
(35, 'ru_RU', '0', 'Время жизни cookie сессии клиента в секундах', NULL, NULL, NULL),
(36, 'ru_RU', '1', 'Оставить настройки по умолчанию для сессии', NULL, NULL, NULL),
(37, 'ru_RU', '1', 'Язык по умолчанию без перевода', NULL, NULL, NULL),
(52, 'ru_RU', '10', '[Firewall/Bruteforce] Время между Х попыток перебора', NULL, NULL, NULL),
(53, 'ru_RU', '60', '[Firewall] Время между Х попытками', NULL, NULL, NULL),
(54, 'ru_RU', '10', '[Firewall/Bruteforce] Количество возможных попыток перебора', NULL, NULL, NULL),
(55, 'ru_RU', '6', '[Firewall] Количествно возможных попыток', NULL, NULL, NULL),
(56, 'ru_RU', '1', '[Firewall] Активация firewall', NULL, NULL, NULL),
(57, 'ru_RU', '1', 'Разрешить URI закрывающим слешем', NULL, NULL, NULL),
(58, 'ru_RU', '1', 'Показывать страницу ошибок вместо белой страницы при ошибке сервера', NULL, NULL, NULL),
(59, 'ru_RU', 'error.html', 'Имя файла для страницы ошибок', NULL, NULL, NULL),
(60, 'ru_RU', '0', 'Позволять клиентам менять email. 1 - Да, 0 - Нет', NULL, NULL, NULL),
(61, 'ru_RU', '1', NULL, NULL, NULL, NULL),
(62, 'ru_RU', 'ThisIsNotASecret', 'Секретный ключ для CSRF токена', NULL, NULL, NULL),
(63, 'ru_RU', '4', 'Минимальная длина пароля для админа', NULL, NULL, NULL),
(64, 'ru_RU', '1', 'Позволять восстановление утеряного пароля админа (1 - Да, 0 - Нет)', NULL, NULL, NULL),
(65, 'ru_RU', '1', 'Посылать email подтверждения подписчикам рассылки', NULL, NULL, NULL),
(66, 'ru_RU', '20', 'Количество результатов по умолчанию для списка товаров', NULL, NULL, NULL),
(67, 'ru_RU', '20', 'Количество результатов по умолчанию для списка заказов', NULL, NULL, NULL),
(68, 'ru_RU', '20', 'Количество результатов по умолчанию для списка клиентов', NULL, NULL, NULL),
(69, 'ru_RU', '0', NULL, NULL, NULL, NULL),
(70, 'ru_RU', '20', NULL, NULL, NULL, NULL),
(71, 'ru_RU', '', NULL, NULL, NULL, NULL),
(72, 'ru_RU', '', NULL, NULL, NULL, NULL),
(73, 'ru_RU', '1', NULL, NULL, NULL, NULL)
