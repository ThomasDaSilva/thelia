...
INSERT INTO `config_i18n` (`id`, `locale`, `value, `title`, `chapo`, `description`, `postscriptum`) VALUES
{foreach $locales as $locale}
    (1, '{$locale}', '1', {intl l='Check available product stock (1) or ignore it (0) when displaying and changing ordered quantity' locale=$locale}, NULL, NULL, NULL),
    (2, '{$locale}', 'default', {intl l='Name of the active front-office template' locale=$locale}, NULL, NULL, NULL),
    (3, '{$locale}', 'default', {intl l='Name of the active back-office template' locale=$locale}, NULL, NULL, NULL),
    (4, '{$locale}', 'default', {intl l='Name of the active PDF template' locale=$locale}, NULL, NULL, NULL),
    (5, '{$locale}', 'default', {intl l='Name of the active mailing template' locale=$locale}, NULL, NULL, NULL),
    (6, '{$locale}', '1', {intl l='Enable (1) or disable (0) URL rewriting' locale=$locale}, NULL, NULL, NULL),
    (7, '{$locale}', 'gd', {intl l='Name of the graphic driver used by the Imagine library (see https://imagine.readthedocs.org)' locale=$locale}, NULL, NULL, NULL),
    (8, '{$locale}', '90', {intl l='The default quality (in %) of the generated images' locale=$locale}, NULL, NULL, NULL),
    (9, '{$locale}', 'symlink', {intl l='How original (full resolution) images are delivered in the web space (symlink or copy)' locale=$locale}, NULL, NULL, NULL),
    (10, '{$locale}', 'symlink', {intl l='How document files are delivered in the web space (symlink or copy)' locale=$locale}, NULL, NULL, NULL),
    (11, '{$locale}', 'local/media/images', {intl l='Path to the directory where images are stored' locale=$locale}, NULL, NULL, NULL),
    (12, '{$locale}', 'local/media/documents', {intl l='Path to the directory where documents are stored' locale=$locale}, NULL, NULL, NULL),
    (13, '{$locale}', 'cache/images', {intl l='The path to the image cache directory in the web space' locale=$locale}, NULL, NULL, NULL),
    (14, '{$locale}', 'cache/documents', {intl l='The path to the document cache directory in the web space' locale=$locale}, NULL, NULL, NULL),
    (15, '{$locale}', '404.html', {intl l='File name of the 404 (not found) view in the current template (with extension, e.g. 404.html)' locale=$locale}, NULL, NULL, NULL),
    (16, '{$locale}', 'obsolete-rewritten-url', {intl l='Name of the template view returned when an obsolete (or inactive) product URL is invoked' locale=$locale}, NULL, NULL, NULL),
    (17, '{$locale}', '0', {intl l='Display and process prices with (0) or without (1) taxes.' locale=$locale}, NULL, NULL, NULL),
    (18, '{$locale}', '0', {intl l='Compile templates assets automatically upon asset source change (1 = yes, 0 = no)' locale=$locale}, NULL, NULL, NULL),
    (19, '{$locale}', 'tarmcn', {intl l='"Remember me" cookie name for administration users' locale=$locale}, NULL, NULL, NULL),
    (20, '{$locale}', '2592000', {intl l='"Remember me" cookie expiration time, in seconds, for administration users' locale=$locale}, NULL, NULL, NULL),
    (21, '{$locale}', 'tcrmcn', {intl l='"Remember me" cookie name for customer users' locale=$locale}, NULL, NULL, NULL),
    (22, '{$locale}', '31536000', {intl l='"Remember me" cookie expiration time, in seconds, for customer users' locale=$locale}, NULL, NULL, NULL),
    (23, '{$locale}', '', {intl l='Base URL of the shop (e.g. http://www.yourshopdomain.com)' locale=$locale}, NULL, NULL, NULL),
    (24, '{$locale}', 'invoice', {intl l='Name of the invoice view in the current PDF template (without extension)' locale=$locale}, NULL, NULL, NULL),
    (25, '{$locale}', 'delivery', {intl l='Name of the delivery view in the current PDF template (without extension)' locale=$locale}, NULL, NULL, NULL),
    (26, '{$locale}', 'assets/img/flags/unknown.png', {intl l='The path (relative to the default back-office template) to the image used when no flag image can be found for a country' locale=$locale}, NULL, NULL, NULL),
    (27, '{$locale}', '1', {intl l='Whitespace trim level of the generated HTML code (0 = none, 1 = medium, 2 = maximum)' locale=$locale}, NULL, NULL, NULL),
    (28, '{$locale}', '100', {intl l='Default available stock when check-available-stock is set to 0.' locale=$locale}, NULL, NULL, NULL),
    ...
    (31, '{$locale}', '0', {intl l='Allow negative product stock (1) or not (0)' locale=$locale}, NULL, NULL, NULL),
    (32, '{$locale}', '1', {intl l='Use a persistent cookie to keep track of customer cart' locale=$locale}, NULL, NULL, NULL),
    (33, '{$locale}', 'thelia_cart', {intl l='Name of the cart cookie' locale=$locale}, NULL, NULL, NULL),
    (34, '{$locale}', '31536060', {intl l='Life time of the cart cookie in the customer browser, in seconds' locale=$locale}, NULL, NULL, NULL),
    (35, '{$locale}', '0', {intl l='Life time of the session cookie in the customer browser, in seconds' locale=$locale}, NULL, NULL, NULL),
    (36, '{$locale}', '1', {intl l='Leave the default configuration of session' locale=$locale}, NULL, NULL, NULL),
    (37, '{$locale}', '1', {intl l='Default lang without translation' locale=$locale}, NULL, NULL, NULL),
    (52, '{$locale}', '10', {intl l='[Firewall/Bruteforce] Time to wait between X attempts' locale=$locale}, NULL, NULL, NULL),
    (53, '{$locale}', '60', {intl l='[Firewall] Time to wait between X attempts' locale=$locale}, NULL, NULL, NULL),
    (54, '{$locale}', '10', {intl l='[Firewall/Bruteforce] Number of allowed attemps' locale=$locale}, NULL, NULL, NULL),
    (55, '{$locale}', '6', {intl l='[Firewall] Number of allowed attemps' locale=$locale}, NULL, NULL, NULL),
    (56, '{$locale}', '1', {intl l='[Firewall] Activate the firewall' locale=$locale}, NULL, NULL, NULL),
    (57, '{$locale}', '1', {intl l='Allow slash ended uri' locale=$locale}, NULL, NULL, NULL),
    (58, '{$locale}', '1', {intl l='Show error message instead of a white page on a server error' locale=$locale}, NULL, NULL, NULL),
    (59, '{$locale}', 'error.html', {intl l='Filename of the error page' locale=$locale}, NULL, NULL, NULL),
    (60, '{$locale}', '0', {intl l='Allow customers to change their email. 1 for yes, 0 for no' locale=$locale}, NULL, NULL, NULL),
    (61, '{$locale}', '1', {intl l='Ask the customers to confirm their email in customer creation form, 1 for yes, 0 for no' locale=$locale}, NULL, NULL, NULL),
    (62, '{$locale}', 'ThisIsNotASecret', {intl l='Secret key for form CSRF token' locale=$locale}, NULL, NULL, NULL),
    (63, '{$locale}', '4', {intl l='The minimum length required for an administrator password' locale=$locale}, NULL, NULL, NULL),
    (64, '{$locale}', '1', {intl l='Allow an administrator to recreate a lost password (1 = yes, 0 = no)' locale=$locale}, NULL, NULL, NULL),
    (65, '{$locale}', '1', {intl l='Send a confirmation email to newsletter subscribers (1 = yes, 0 = no)' locale=$locale}, NULL, NULL, NULL),
    (66, '{$locale}', '20', {intl l='Number by default of results per page for product list' locale=$locale}, NUll, NULL, NULL),
    (67, '{$locale}', '20', {intl l='Number by default of results per page for order list' locale=$locale}, NUll, NULL, NULL),
    (68, '{$locale}', '20', {intl l='Number by default of results per page for customer list' locale=$locale}, NUll, NULL, NULL),
    (69, '{$locale}', '0', {intl l='Customer account creation should be confirmed by email (1: yes, 0: no)' locale=$locale}, NULL, NULL, NULL),
    (70, '{$locale}', '20', {intl l='Default number of coupons per page on coupon list' locale=$locale}, NULL, NULL, NULL),
    ...
    (73, '{$locale}', '1', {intl l='Allow module installation from ZIP files.' locale=$locale}, NULL, NULL, NULL){if ! $locale@last},{/if}
